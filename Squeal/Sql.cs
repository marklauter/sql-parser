...
internal static class Sql
{
    public static readonly Tokenizer<SqlToken> Tokenizer = new TokenizerBuilder<SqlToken>()
        ...
        .Match(Span.EqualToIgnoreCase("BLOB"), SqlToken.Blob, true)
        ...
        .Match(Span.EqualToIgnoreCase("INTEGER").Try().Or(Span.EqualToIgnoreCase("INT")), SqlToken.Int, true)
        ...
        .Match(Span.EqualToIgnoreCase("NUMERIC").Try().Or(Span.EqualToIgnoreCase("NUM")), SqlToken.Numeric, true)
        .Match(Span.EqualToIgnoreCase("ON"), SqlToken.On, true)
        .Match(Span.EqualToIgnoreCase("PRIMARY"), SqlToken.Primary, true)
        .Match(Span.EqualToIgnoreCase("REAL"), SqlToken.Real, true)
        ...
        .Match(Span.EqualToIgnoreCase("TEXT"), SqlToken.Text, true)
